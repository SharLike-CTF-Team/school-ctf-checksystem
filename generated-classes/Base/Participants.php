...
abstract class Participants implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ParticipantsTableMap';
    ...
    /**
     * The value for the id_pass field.
     *
     * @var        string
     */
    protected $id_pass;
    ...
    /**
     * Initializes internal state of Base\Participants object.
     */
    ...
    /**
     * Get the [secretkey] column value.
     *
     * @return string
     */
     ...
     * @return $this|\Participants The current object (for fluent API support)
     */
    ...
    public function setTeam_id($v)
    {
        ...
        if ($this->team_id !== $v) {
            $this->team_id = $v;
            $this->modifiedColumns[ParticipantsTableMap::COL_TEAM_ID] = true;
        }
    ...
    public function setPass($v)
    {
        ...
        if ($this->pass !== $v) {
            $this->pass = $v;
            $this->modifiedColumns[ParticipantsTableMap::COL_PASS] = true;
        }
    ...
    /**
     * Set the value of [secretkey] column.
     *
     * @param string $v new value
     * @return $this|\Participants The current object (for fluent API support)
     */
    public function setSecretkey($v)
    {
        ...
        if ($this->secretkey !== $v) {
            $this->secretkey = $v;
            $this->modifiedColumns[ParticipantsTableMap::COL_SECRETKEY] = true;
        }
    ...
    /**
     * Set the value of [id_pass] column.
     *
     * @param string $v new value
     * @return $this|\Participants The current object (for fluent API support)
     */
    public function setId_pass($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->id_pass !== $v) {
            $this->id_pass = $v;
            $this->modifiedColumns[ParticipantsTableMap::COL_ID_PASS] = true;
        }
    ...
    public function setIp($v)
    {
        ...
        if ($this->ip !== $v) {
            $this->ip = $v;
            $this->modifiedColumns[ParticipantsTableMap::COL_IP] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ParticipantsTableMap::translateFieldName('Team_id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->team_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ParticipantsTableMap::translateFieldName('Pass', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pass = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ParticipantsTableMap::translateFieldName('Secretkey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->secretkey = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ParticipantsTableMap::translateFieldName('Id_pass', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_pass = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ParticipantsTableMap::translateFieldName('Ip', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = ParticipantsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Participants'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ParticipantsTableMap::COL_TEAM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'team_id';
        }
        if ($this->isColumnModified(ParticipantsTableMap::COL_PASS)) {
            $modifiedColumns[':p' . $index++]  = 'pass';
        }
        if ($this->isColumnModified(ParticipantsTableMap::COL_SECRETKEY)) {
            $modifiedColumns[':p' . $index++]  = 'secretkey';
        }
        if ($this->isColumnModified(ParticipantsTableMap::COL_ID_PASS)) {
            $modifiedColumns[':p' . $index++]  = 'id_pass';
        }
        if ($this->isColumnModified(ParticipantsTableMap::COL_IP)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'pass':
                        ...
                        break;
                    case 'secretkey':
                        $stmt->bindValue($identifier, $this->secretkey, PDO::PARAM_STR);
                        break;
                    case 'id_pass':
                        $stmt->bindValue($identifier, $this->id_pass, PDO::PARAM_STR);
                        break;
                    case 'ip':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getTeam_id(),
            $keys[2] => $this->getPass(),
            $keys[3] => $this->getSecretkey(),
            $keys[4] => $this->getId_pass(),
            $keys[5] => $this->getIp(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setTeam_id($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setPass($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setSecretkey($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setId_pass($arr[$keys[4]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ParticipantsTableMap::COL_TEAM_ID)) {
            $criteria->add(ParticipantsTableMap::COL_TEAM_ID, $this->team_id);
        }
        if ($this->isColumnModified(ParticipantsTableMap::COL_PASS)) {
            $criteria->add(ParticipantsTableMap::COL_PASS, $this->pass);
        }
        if ($this->isColumnModified(ParticipantsTableMap::COL_SECRETKEY)) {
            $criteria->add(ParticipantsTableMap::COL_SECRETKEY, $this->secretkey);
        }
        if ($this->isColumnModified(ParticipantsTableMap::COL_ID_PASS)) {
            $criteria->add(ParticipantsTableMap::COL_ID_PASS, $this->id_pass);
        }
        if ($this->isColumnModified(ParticipantsTableMap::COL_IP)) {
            $criteria->add(ParticipantsTableMap::COL_IP, $this->ip);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Participants (or compatible) type.
    ...
    {
        $copyObj->setTeam_id($this->getTeam_id());
        $copyObj->setPass($this->getPass());
        $copyObj->setSecretkey($this->getSecretkey());
        $copyObj->setId_pass($this->getId_pass());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Participants Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($v === null) {
            $this->setTeam_id(NULL);
        } else {
            $this->setTeam_id($v->getId());
        }
    ...
    public function getTeam(ConnectionInterface $con = null)
    {
        if ($this->aTeam === null && ($this->team_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTeam->addParticipantss($this);
             */
        }
    ...
    {
        if (null !== $this->aTeam) {
            $this->aTeam->removeParticipants($this);
        }
        $this->id = null;
        $this->team_id = null;
        $this->pass = null;
