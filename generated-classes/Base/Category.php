...
abstract class Category implements ActiveRecordInterface
{
    ...
    public function setLogoLink($v)
    {
        ...
        if ($this->logo_link !== $v) {
            $this->logo_link = $v;
            $this->modifiedColumns[CategoryTableMap::COL_LOGO_LINK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategoryTableMap::translateFieldName('LogoLink', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_LOGO_LINK)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_LOGO_LINK)) {
            $criteria->add(CategoryTableMap::COL_LOGO_LINK, $this->logo_link);
        }
