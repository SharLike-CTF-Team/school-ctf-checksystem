...
class CategoryTableMap extends TableMap
{
     ...
     */
    const COL_LOGO_LINK = 'category.logo_link';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'LogoLink', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'logoLink', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID, CategoryTableMap::COL_TITLE, CategoryTableMap::COL_LOGO_LINK, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'logo_link', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'LogoLink' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'logoLink' => 2, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID => 0, CategoryTableMap::COL_TITLE => 1, CategoryTableMap::COL_LOGO_LINK => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'logo_link' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryTableMap::COL_LOGO_LINK);
        } else {
