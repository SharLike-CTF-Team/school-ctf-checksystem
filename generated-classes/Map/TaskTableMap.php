...
class TaskTableMap extends TableMap
{
     ...
     */
    const COL_POINTS = 'task.points';

    /**
     * the column name for the flag field
     */
    const COL_FLAG = 'task.flag';

    /**
     * the column name for the logo_link field
     */
    const COL_LOGO_LINK = 'task.logo_link';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'CategoryId', 'Title', 'Description', 'Points', 'Flag', 'LogoLink', ),
        self::TYPE_CAMELNAME     => array('id', 'categoryId', 'title', 'description', 'points', 'flag', 'logoLink', ),
        self::TYPE_COLNAME       => array(TaskTableMap::COL_ID, TaskTableMap::COL_CATEGORY_ID, TaskTableMap::COL_TITLE, TaskTableMap::COL_DESCRIPTION, TaskTableMap::COL_POINTS, TaskTableMap::COL_FLAG, TaskTableMap::COL_LOGO_LINK, ),
        self::TYPE_FIELDNAME     => array('id', 'category_id', 'title', 'description', 'points', 'flag', 'logo_link', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'CategoryId' => 1, 'Title' => 2, 'Description' => 3, 'Points' => 4, 'Flag' => 5, 'LogoLink' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'categoryId' => 1, 'title' => 2, 'description' => 3, 'points' => 4, 'flag' => 5, 'logoLink' => 6, ),
        self::TYPE_COLNAME       => array(TaskTableMap::COL_ID => 0, TaskTableMap::COL_CATEGORY_ID => 1, TaskTableMap::COL_TITLE => 2, TaskTableMap::COL_DESCRIPTION => 3, TaskTableMap::COL_POINTS => 4, TaskTableMap::COL_FLAG => 5, TaskTableMap::COL_LOGO_LINK => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'category_id' => 1, 'title' => 2, 'description' => 3, 'points' => 4, 'flag' => 5, 'logo_link' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('category_id', 'CategoryId', 'INTEGER', 'category', 'id', true, 5, null);
        $this->addColumn('title', 'Title', 'VARCHAR', true, 32, null);
        $this->addColumn('description', 'Description', 'LONGVARCHAR', true, null, null);
        $this->addColumn('points', 'Points', 'INTEGER', true, 5, null);
        $this->addColumn('flag', 'Flag', 'VARCHAR', true, 32, null);
        $this->addColumn('logo_link', 'LogoLink', 'VARCHAR', true, 32, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Hint', '\\Hint', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':task_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TaskTableMap::COL_POINTS);
            $criteria->addSelectColumn(TaskTableMap::COL_FLAG);
            $criteria->addSelectColumn(TaskTableMap::COL_LOGO_LINK);
        } else {
